...
| Lighthouse Perf 90 | 로컬 NOT_RUN / 이전 CI FAIL | 직전 근거 `cdae756` run 34469740629: 로그인 0.86, 홈 0.90, 기회 0.89, 입금 0.87, 나 0.88. 이번 푸시 점수는 Actions 대기. 임계값 하향 안 함 | Perf 90. 게이트 완화 질문 안 함 |
