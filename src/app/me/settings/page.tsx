...
import { useCommonUi, usePutdukAi } from "@/lib/gpt/GptScopes";
...
export default function MeSettingsPage() {
  ...
  const { resetConversation } = usePutdukAi();
  ...
  return (
    <RouteScreen>
      ...
      <section className="danger-card">
        ...
        <button type="button" onClick={resetConversation} aria-label="퍼뜩AI 대화 지우기">
          대화 지우기
        </button>
      </section>
    </RouteScreen>
