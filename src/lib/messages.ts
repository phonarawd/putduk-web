...
export const MSG = {
  ...
  aiBusy: "지금은 잠시 바빠요. 조금 뒤 다시 물어봐 주세요.",
  resellerIdEmpty: "아직 표시할 아이디가 없어요",
  membershipEmpty: "아직 표시할 등급이 없어요",
  membershipCapEmpty: "아직 표시할 횟수가 없어요",
  membershipChecking: "등급을 확인하고 있어요.",
  membershipLoadFail: "등급을 확인하지 못했어요.",
  inviteLoadFail: "초대 정보를 확인하지 못했어요.",
  benefitsChecking: "혜택을 확인하고 있어요.",
  benefitsLoadFail: "혜택을 확인하지 못했어요.",
  benefitsEmpty: "아직 표시할 혜택이 없어요",
  trialRemainingEmpty: "아직 표시할 횟수가 없어요",
